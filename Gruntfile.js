  ...
  grunt.initConfig({
        ...
        files: [
          {
              ...
              dest: 'sphinx_rtb_theme/static/fonts/',
              filter: 'isFile'
          },
          {
              expand: true,
    ...
    sass: {
      dev: {
        ...
        files: [{
          ...
          cwd: 'sass',
          src: ['*.sass'],
          dest: 'sphinx_rtb_theme/static/css',
          ext: '.css'
        }]
      },
      build: {
    ...
    browserify: {
      dev: {
        ...
        src: ['js/*.js'],
        dest: 'sphinx_rtb_theme/static/js/theme.js'
      },
      build: {
        options: {
          external: ['jquery'],
    ...
    clean: {
      ...
      fonts: ["sphinx_rtb_theme/static/fonts"]
    },
    ...
    watch: {
      ...
      sphinx: {
        files: ['sphinx_rtb_theme/**/*', 'demo_docs/**/*.rst', 'demo_docs/**/*.py'],
